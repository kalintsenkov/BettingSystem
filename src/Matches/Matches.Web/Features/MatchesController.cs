namespace BettingSystem.Web.Matches.Features
{
    using System.Collections.Generic;
    using System.Threading.Tasks;
    using Application.Common;
    using Application.Matches.Matches.Commands.Cancel;
    using Application.Matches.Matches.Commands.Create;
    using Application.Matches.Matches.Commands.Delete;
    using Application.Matches.Matches.Commands.Edit;
    using Application.Matches.Matches.Commands.Finish;
    using Application.Matches.Matches.Commands.FirstHalf;
    using Application.Matches.Matches.Commands.HalfTime;
    using Application.Matches.Matches.Commands.SecondHalf;
    using Application.Matches.Matches.Queries.Details;
    using Application.Matches.Matches.Queries.Search;
