namespace BettingSystem.Web.Features
{
    ...
    using Application.Competitions.Matches.Commands.Cancel;
    using Application.Competitions.Matches.Commands.Create;
    using Application.Competitions.Matches.Commands.Delete;
    using Application.Competitions.Matches.Commands.Edit;
    using Application.Competitions.Matches.Commands.Finish;
    using Application.Competitions.Matches.Commands.FirstHalf;
    using Application.Competitions.Matches.Commands.HalfTime;
    using Application.Competitions.Matches.Commands.SecondHalf;
    using Application.Competitions.Matches.Queries.Details;
    using Application.Competitions.Matches.Queries.Search;
