...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BettingSystem.Domain.Betting.Models.Matches.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingSystem.Domain.Betting.Models.Gamblers.Gambler", b =>
                {
                    b.HasOne("BettingSystem.Infrastructure.Identity.User", null)
                        .WithOne()
                        .HasForeignKey("BettingSystem.Domain.Betting.Models.Gamblers.Gambler", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BettingSystem.Domain.Betting.Models.Matches.Match", b =>
                {
                    b.HasOne("BettingSystem.Domain.Betting.Models.Matches.Team", "AwayTeam")
                        .WithMany()
                        .HasForeignKey("AwayTeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BettingSystem.Domain.Betting.Models.Matches.Team", "HomeTeam")
                        .WithMany()
