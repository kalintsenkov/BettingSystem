...
namespace BettingSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201123183203_MatchStatisticsStatus")]
    partial class MatchStatisticsStatus
    {
                    ...
                    b.OwnsOne("BettingSystem.Domain.Models.Matches.Statistics", "Statistics", b1 =>
                        {
                            ...
                            b1.OwnsOne("BettingSystem.Domain.Models.Matches.Status", "Status", b2 =>
                                {
                                    b2.Property<int>("StatisticsMatchId")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("int")
                                        .UseIdentityColumn();
                                    ...
                                    b2.HasKey("StatisticsMatchId");

                                    b2.ToTable("Matches");

                                    b2.WithOwner()
                                        .HasForeignKey("StatisticsMatchId");
                                });
